...
class PlayGame extends Phaser.Scene {
     ...
     *  @param hand {hand} ein Array mit den Handkarten
     */
    showHand(hand) {
     ...
     *  1 = [yield,5]
     *  0 = [yield]
     *  @param listener {Tutorialcontroller} Objekt mit der Callback-Methode `tricksChosen(number)`
     */
     ...
     * @param listener {Tutorialcontroller} Objekt mit der Callback-Methode `trumpffarbePicked(String)`
     */
